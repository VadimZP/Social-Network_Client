export default class Utils {
  static getCountries() {
    return [
      ...
      { alpha2Code: 'AX', name: "Åland Islands" },
      ...
      { alpha2Code: 'BO', name: "Bolivia, Plurinational State of" },
      { alpha2Code: 'BQ', name: "Bonaire, Sint Eustatius and Saba" },
      ...
      { alpha2Code: 'BN', name: "Brunei Darussalam" },
      ...
      { alpha2Code: 'CC', name: "Cocos (Keeling) Islands" },
      { alpha2Code: 'CO', name: "Colombia" },
      { alpha2Code: 'KM', name: "Comoros" },
      { alpha2Code: 'CG', name: "Congo" },
      { alpha2Code: 'CD', name: "Congo, the Democratic Republic of the" },
      { alpha2Code: 'CK', name: "Cook Islands" },
      { alpha2Code: 'CR', name: "Costa Rica" },
      { alpha2Code: 'CI', name: "Côte d'Ivoire" },
      { alpha2Code: 'HR', name: "Croatia" },
      { alpha2Code: 'CU', name: "Cuba" },
      { alpha2Code: 'CW', name: "Curaçao" },
      ...
      { alpha2Code: 'FK', name: "Falkland Islands (Malvinas)" },
      ...
      { alpha2Code: 'VA', name: "Holy See (Vatican City State)" },
      ...
      { alpha2Code: 'IR', name: "Iran, Islamic Republic of" },
      ...
      { alpha2Code: 'KP', name: "Korea, Democratic People's Republic of" },
      { alpha2Code: 'KR', name: "Korea, Republic of" },
      { alpha2Code: 'KW', name: "Kuwait" },
      { alpha2Code: 'KG', name: "Kyrgyzstan" },
      { alpha2Code: 'LA', name: "Lao People's Democratic Republic" },
      ...
      { alpha2Code: 'MK', name: "Macedonia, the former Yugoslav Republic of" },
      ...
      { alpha2Code: 'FM', name: "Micronesia, Federated States of" },
      { alpha2Code: 'MD', name: "Moldova, Republic of" },
      ...
      { alpha2Code: 'PS', name: "Palestinian Territory, Occupied" },
      ...
      { alpha2Code: 'RE', name: "Réunion" },
      { alpha2Code: 'RO', name: "Romania" },
      { alpha2Code: 'RU', name: "Russian Federation" },
      { alpha2Code: 'RW', name: "Rwanda" },
      { alpha2Code: 'BL', name: "Saint Barthélemy" },
      { alpha2Code: 'SH', name: "Saint Helena, Ascension and Tristan da Cunha" },
      { alpha2Code: 'KN', name: "Saint Kitts and Nevis" },
      { alpha2Code: 'LC', name: "Saint Lucia" },
      { alpha2Code: 'MF', name: "Saint Martin (French part)" },
      ...
      { alpha2Code: 'SX', name: "Sint Maarten (Dutch part)" },
      ...
      { alpha2Code: 'TW', name: "Taiwan, Province of China" },
      { alpha2Code: 'TJ', name: "Tajikistan" },
      { alpha2Code: 'TZ', name: "Tanzania, United Republic of" },
      { alpha2Code: 'TH', name: "Thailand" },
      { alpha2Code: 'TL', name: "Timor-Leste" },
      ...
      { alpha2Code: 'VE', name: "Venezuela, Bolivarian Republic of" },
      { alpha2Code: 'VN', name: "Viet Nam" },
      { alpha2Code: 'VG', name: "Virgin Islands, British" },
      { alpha2Code: 'VI', name: "Virgin Islands, U.S." },
